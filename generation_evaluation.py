...
if __name__ == "__main__":
    ...
    model = PixelCNN(nr_resnet=5, nr_filters=100, input_channels=3, nr_logistic_mix=10)
    model.load_state_dict(torch.load("models/pcnn_cpen455_from_scratch_49.pth", map_location=device))
